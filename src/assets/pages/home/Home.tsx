...
import { verticalMacaron, verticalMatchaStack, verticalHazelnutCookies } from "../../images/vertical";
...
const Home = () => {
  return (
    <>
      ...
      <ParallaxSection height="65vh" img={parallaxOne} vertImg={verticalHazelnutCookies}>
        {reviews[0]}
      </ParallaxSection>

      <FeaturedProducts></FeaturedProducts>

      <ParallaxSection height="65vh" img={parallaxTwo} vertImg={verticalMacaron}>
        {reviews[1]}
      </ParallaxSection>

      <MacaronCake></MacaronCake>

      <ParallaxSection height="65vh" img={parallaxThree} vertImg={verticalMatchaStack}>
        {reviews[2]}
      </ParallaxSection>
